...
rule plot_t33a_n1039_all_heatmaps:
    input:
        rules.make_t33a_n1039_xvg.output,
    output:
...
rule make_t33a_n1039_xvg_clip_10ns:
    input:
...
rule plot_t33a_n1039_kde_clip_10ns:
    input:
        rules.make_t33a_n1039_xvg_clip_10ns.output,
    output:
