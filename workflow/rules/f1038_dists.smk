...
rule plot_t33a_f1038_y993_heatmap:
    input:
        rules.make_t33a_f1038_xvgs.output,
    output:
...
rule make_t33a_f1038_xvgs_clip_10ns:
    input:
...
rule plot_t33a_y993_f1038_kde_clip_10ns:
    input:
        f1=rules.make_t33a_f1038_xvgs_clip_10ns.output,
    output:
